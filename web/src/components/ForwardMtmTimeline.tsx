...
export function ForwardMtmTimeline() {
  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 0; i <= 20; i++) {
      ...
      points.push({ st: stSample, vt: forwardMtmNoCashFlows(stSample, f0, r, maturity, t) });
    }
    return points;
  }, [s0, f0, r, maturity, t]);
  ...
  return (
    <section>
      ...
      <div className="card">
        ...
        <Katex latex={LATEX_PV_OF_FORWARD} />
        <div className="stat-row">
          <div className="stat">
        ...
        <Katex latex={LATEX_FORWARD_MTM_NO_CF} />
        <div className="stat-row">
        ...
        <ResponsiveContainer width="100%" height={280}>
          <LineChart data={chartData} margin={{ top: 10, right: 12, left: 0, bottom: 0 }}>
            ...
            <Line type="monotone" dataKey="vt" stroke="#e8a33d" strokeWidth={2.5} dot={false} isAnimationActive={false} name="Vt" />
